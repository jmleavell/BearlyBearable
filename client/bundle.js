...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__App_jsx__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__BearMaker_jsx__ = __webpack_require__(35);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__BearMaker_jsx__["a" /* default */], null)
        );
    }
}
...
class BearMaker extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor(props) {
        super(props);
    ...
    onBearHandler(e) {
        ...
        if (e.target.name === 'create') {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/bears', { name: myBear }).then(function (resp) {
                console.log(resp);
            }).catch(function (err) {
                console.log('Oh no, you broke it.');
            });
        } else {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('/api/bears/' + myBear).then(function (resp) {
                console.log(resp);
            }).catch(function (err) {
                console.log('Oh no, you broke it.');
            });
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            null,
            'Bear Name: ',
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', name: 'bear', onChange: this.onChangeHandler }),
            ' ',
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('br', null),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'button',
                { onClick: this.onBearHandler, name: 'create' },
                'Create Bear'
            ),
            ' ',
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'button',
                { onClick: this.onBearHandler, name: 'kill' },
                'Delete Bear'
            )
        );
    }
...
/* harmony default export */ __webpack_exports__["a"] = (BearMaker);
